...
def plot_PCA(finalDf, xaxis, yaxis):
    ...
    scores = [1, 3, 5, 7, 10]
    colors = ['r','yellowgreen', 'cyan', 'midnightblue', 'mediumpurple']
    for minscore, maxscore, color in zip(scores,scores[1:],colors):
        ...
        ax.scatter(finalDf.loc[plot_indices, 'principal component 1'], finalDf.loc[plot_indices, 'principal component 2'], s=10, c=color)
